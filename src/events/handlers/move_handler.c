...
/*   Updated: 2025/08/31 11:00:05 by ihajji           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (code == XK_Up)
		*point = translate(*point, cam.forward);
	else if (code == XK_Down)
		*point = translate(*point, vec3_negate(cam.forward));
	else if (code == XK_Right)
		*point = translate(*point, cam.right);
	else if (code == XK_Left)
		*point = translate(*point, vec3_negate(cam.right));
	else if (code == XK_Page_Up)
		*point = translate(*point, cam.up);
	else if (code == XK_Page_Down)
		*point = translate(*point, vec3_negate(cam.up));
}
